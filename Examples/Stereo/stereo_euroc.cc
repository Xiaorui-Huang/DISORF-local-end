...
int main(int argc, char **argv)
{
    ...
    if (argc < 6 || argc > 7) {
        cerr << endl 
             << "Usage: "<< argv[0] << " path_to_vocabulary path_to_settings path_to_left_folder path_to_right_folder path_to_times_file [address:port]" << endl
    ...
    ORB_SLAM2::System SLAM(argv[1],argv[2],ORB_SLAM2::System::STEREO, address, port, true);
